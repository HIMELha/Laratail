        ...
        <div class="grid flex-col md:col-span-1  md:mr-2">
            <div class="shadow-md shadow-blue-100 border border-slate-300 rounded-[4px] px-4 py-3">
                <div class="flex flex-col">
                    ...
                    {{-- <a href="" class="text-[14px] text-sky-600 ml-1 hover:underline font-normal">Follow</a> --}}
                    <div class="flex gap-2">
                    <a href="" class="text-[14px] text-slate-800 font-medium hover:underline"><i class="fa-solid fa-square-rss mr-1 text-[15px]"></i>48 posts</a>
                    <a href="" class="text-[14px] text-slate-800 font-medium hover:underline"><i class="fa-solid fa-users mr-1 text-[14px]"></i>405 followers</a>
                    </div>
