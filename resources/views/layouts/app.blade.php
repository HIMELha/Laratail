...
<body>
    ...
    <header class="w-full z-20  flex justify-between items-center px-4 py-2 shadow-md bg-white shadow-sky-100 rounded-b-sm fixed top-0 left-0 right-0">
        <a href="{{ route('index') }}" class="text-[17px] font-medium p-1 text-blue-600">LaraTail</a>
        ...
        <ul class="flex gap-2">
            ...
            <li class="relative group"><a href="" class="text-[13px] font-medium text-gray-700 p-1 hover:text-slate-800 ">Account</a>
                ...
                <div class="flex-col px-2 py-1 shadow-md shadow-blue-100 absolute top-[26px] right-[1px] bg-slate-800 rounded-md hidden group-hover:flex transition-all duration-200 min-w-[100px] text-center">
                    @guest
                        <a href="{{ route('login') }}" class="text-[13px] font-medium text-gray-100 p-1 hover:text-slate-300">Sign In</a>
                    @else
                        <a href="{{ route('profile') }}" class="text-[13px] font-medium text-gray-100 p-1 hover:text-slate-300">My account</a>
                        <a href="{{ route('logout') }}" class="text-[13px] font-medium text-gray-100 p-1 hover:text-slate-300">Logout</a>
                    @endguest
                    {{-- <a href="" class="text-[13px] font-medium text-gray-100 p-1 hover:text-slate-300">Register</a> --}}
                </div>
