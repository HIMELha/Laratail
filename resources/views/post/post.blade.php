<div class="blog">
    <div class="flex justify-between items-center">
        <div>
            <a href="" class="text-[16px] font-medium uppercase text-sky-600 hover:text-blue-600">Laravel 10 has big 5 changes ~</a> <span class="text-[13px] text-yellow-500">Morgan fox</span>
        </div>
